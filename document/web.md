...
laravel框架把服务提供类【包括自己的和第三方的laravel扩展包】全部注册放在容器里Application[Container]保存【服务调度集权，类似集权中心，所有资源全在它手上掌握，需要用时它调度出来并实例化服务提供类返回】从而让容器集中了整个框架大量的服务  

各位百度他们说的更玄乎，其实就是把所有的服务提供类【如路由，请求，响应，控制器调度，模型，数据库操作，缓存，队列，事件等全搞成服务扩展包】，然后将他们全部保存在一个数组里，要用的时候取出来装逼】本身容器是没有这些功能的，相当于一个人把各家所长，各家武术集中在自己身上，取出来的时候帮你完成服务类的反射传递给你使用。   【感觉像一堆废话】
